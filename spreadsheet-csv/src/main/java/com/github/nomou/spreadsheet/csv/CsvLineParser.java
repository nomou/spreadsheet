...
/**
 * A very simple CSV parser, this just implements splitting a single line into fields.
 */
class CsvLineParser {
    /**
     ...
     */
    public CsvLineParser(char separator, char quotechar, char escape, boolean strictQuotes, boolean ignoreLeadingWhiteSpace) {
