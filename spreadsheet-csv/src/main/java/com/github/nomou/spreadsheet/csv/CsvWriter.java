...
class CsvWriter implements Closeable, Flushable {
     ...
     * eg:
     * HttpServletResponse.setCharacterEncoding(CsvWriter.GBK.name());
     * final CsvWriter writer = new CsvWriter(resp.getWriter());
     *
     ...
     */
    public CsvWriter writeAll(List<String[]> allLines, boolean applyQuotesToAll) {
     ...
     *                 the file.
     */
    public CsvWriter writeAll(List<String[]> allLines) {
        for (String[] line : allLines) {
            writeNext(line);
        }
        return this;
     ...
     */
    public CsvWriter writeNext(String[] nextLine, boolean applyQuotesToAll) {
        if (nextLine == null) {
            return this;
        }
     ...
     *                 entry.
     */
    public CsvWriter writeNext(String[] nextLine) {
